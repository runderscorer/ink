...
prompt = Prompt.create(text: 'Shall I compare thee to a summer’s day? Thou art more lovely and more temperate:')
...
prompt = Prompt.create(text: 'Because I could not stop for Death— He kindly stopped for me—')
Response.create(text: 'The Carriage held but just Ourselves— And Immortality.', prompt_id: prompt.id, correct: true)

prompt = Prompt.create(text: 'She walks in beauty, like the night Of cloudless climes and starry skies;')
...
prompt = Prompt.create(text: 'O Captain! my Captain! our fearful trip is done, The ship has weather’d every rack, the prize we sought is won,')
Response.create(text: 'The port is near, the bells I hear, the people all exulting,', prompt_id: prompt.id, correct: true)

prompt = Prompt.create(text: 'Two roads diverged in a yellow wood, And sorry I could not travel both')
...
prompt = Prompt.create(text: 'Hold fast to dreams For if dreams die')
Response.create(text: 'Life is a broken-winged bird That cannot fly.', prompt_id: prompt.id, correct: true)

prompt = Prompt.create(text: 'Once upon a midnight dreary, while I pondered, weak and weary, Over many a quaint and curious volume of forgotten lore—')
...
prompt = Prompt.create(text: 'I wandered lonely as a cloud That floats on high o’er vales and hills,')
Response.create(text: 'When all at once I saw a crowd, A host, of golden daffodils;', prompt_id: prompt.id, correct: true)

prompt = Prompt.create(text: 'The woods are lovely, dark and deep, But I have promises to keep,')
